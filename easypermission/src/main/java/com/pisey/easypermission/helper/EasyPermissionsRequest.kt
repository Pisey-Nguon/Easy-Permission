...
data class EasyPermissionsRequest(
    ...
    internal var rationaleMethod: ((EasyPermissionsRequest) -> Unit)? = null,
    internal var permanentDeniedMethod: ((EasyPermissionsRequest) -> Unit)? = null,
    internal var permissionsDeniedMethod: ((EasyPermissionsRequest) -> Unit)? = null,
